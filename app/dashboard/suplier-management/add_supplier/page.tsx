    ...
    return (
        <div className="px-5">
            ...
            <form className="grid gap-4 md:grid-cols-2 lg:grid-cols-3" onSubmit={handleSubmit((data) => onSubmit.mutate(data))} noValidate>
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3" >                <ControlledInput
                    label="First Name"
                    type="text"
                    name="firstName"
...
<div className="text-blue grid gap-4 md:grid-cols-2 lg:grid-cols-1">
<ControlledInput
                    label="label"
                    type="text"
                    name={`label`}
                ...
                <ControlledSelect
                    ...
                    name="userCategory"
                    options={
                        userCategory.map((category: { _id: any; role: any; }) => ({
                            value: category._id,
                            label: category.role,
                        }))
                    }
                ...
                <ControlledSelect
                    ...
                    options={
                        supplierCategory.map((category: { _id: any; name: any; }) => ({
                            value: category._id,
                            label: category.name,
                        }))
                    }
